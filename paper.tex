...
\begin{figure}[H]
    ...
    \end{center}
    \centering
    \caption{AHABus Frame Format – Second Iteration}
...
\begin{figure}[H]
    ...
    \begin{bytefield}[bitwidth=0.65em]{64}
        ...
        \bitbox{8}{0xAA} & \bitbox{8}{0x5A} & \bitbox{8}{version} &
        \bitbox{16}{sequence number} &
        \bitbox{24}{data}
    \end{bytefield}
    \end{center}
...
\begin{figure}[H]
    ...
    \draw (38.7,-4.8) node [above] {$byte!=AA$};
    \end{tikzpicture}
    \end{center}
    \centering
    \caption{AHABus Frame Synchronisation}
\end{figure}
